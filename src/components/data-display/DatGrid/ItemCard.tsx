    ...
    >
      ...
      <div className="absolute top-3 right-3 z-10 flex gap-1">
        ...
        <Button
          size="sm"
          variant="ghost"
          className="h-8 w-8 p-0 opacity-0 group-hover:opacity-100 transition-opacity bg-black/50 backdrop-blur-sm text-white/60 hover:text-white hover:bg-white/20"
          onClick={(e) => {
            e.stopPropagation();
        ...
        >
          <Pin className={cn("h-4 w-4", isPinned && "fill-yellow-400 text-yellow-400")} />
        </Button>
